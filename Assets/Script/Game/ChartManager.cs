...
public partial class ChartManager : Control
{
    ...
    var jsonText = FileAccess.Open($"{rootPath.GetCurrentDir()}/{_chartData.ChartFileName}", FileAccess.ModeFlags.Read)
        .GetAsText();
...
public void CalcUiSize()
{
    ...
    BackGroundControl.Scale = Size / BackGroundControl.Size;
